...
public class TemplateController {
    ...
    public ResponseEntity<Page<TemplateResponseDto>> getAllTemplates(
            @Parameter(description = "Filter by name containing")
        ...
        Page<TemplateResponseDto> templates = templateService.getAllTemplates(
                name, type, tags, createdBy, pageable);
    ...
    public ResponseEntity<TemplateResponseDto> createTemplate(
        ...
        TemplateResponseDto createdTemplate = templateService.createTemplate(
    ...
    public ResponseEntity<TemplateResponseDto> updateTemplate(
        ...
        TemplateResponseDto updatedTemplate = templateService.updateTemplate(
    ...
    @Operation(
            ...
            description = "Soft deletes a template by its ID"
    )
    ...
    public ResponseEntity<TemplateResponseDto> getTemplateVersion(
            ...
            @Parameter(description = "Version string", required = true)
